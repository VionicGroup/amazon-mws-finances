...
use MWSF\Model\MWSFinancesService_Model_GetServiceStatusRequest;
use MWSF\Model\MWSFinancesService_Model_GetServiceStatusResponse;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventGroupsByNextTokenRequest;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventGroupsByNextTokenResponse;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventGroupsRequest;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventGroupsResponse;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventsByNextTokenRequest;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventsByNextTokenResponse;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventsRequest;
use MWSF\Model\MWSFinancesService_Model_ListFinancialEventsResponse;
use MWSF\Model\MWSFinancesService_Model_ResponseHeaderMetadata;


/**
 * Class MWSFinancesService_Client
 * @package MWSF
 */
class MWSFinancesService_Client implements MWSFinancesService_Interface
{
    ...
    private  $_config = array ('ServiceURL' => null,
                               'UserAgent' => 'MWSFinancesService PHP7 Library',
                               'SignatureVersion' => 2,
     ...
     *
     * @throws MWSFinancesService_Exception*@throws Exception
     * @throws Exception
